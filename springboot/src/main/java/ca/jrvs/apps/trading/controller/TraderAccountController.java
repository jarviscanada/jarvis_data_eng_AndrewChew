...
public class TraderAccountController {
  ...
  @ApiOperation(value = "Deposit a fund.",
      notes = "Deposit a fund from the account that is associated with the given traderId. "
  ...
  @ApiOperation(value = "Withdraw a fund.",
      notes = "Withdraw a fund from the account that is associated with the given traderId. "
